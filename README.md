...
### Abstract  
We have been tasked with providing analysis of ride-sharing data across the first four months of Y2019 (Jan-Mar) for PyBer. We provide this overview focused on the three city 'types' as defined by PyBer: Urban, Suburban, and Rural. Also provided is a line graph illustrating total weekly fares over the time period by city type. 
